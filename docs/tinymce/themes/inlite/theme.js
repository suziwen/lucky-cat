...
var inlite = (function () {
  ...
  var $_27761316ijew5f0c8 = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_908wbj16mjew5f0cc.fromClientRect(clientRect)) : null;
  };
  var $_5pwmxa16ljew5f0cb = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_1e385b16kjew5f0ca.result(predicateIds[i].id, $_5pwmxa16ljew5f0cb.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_1e385b16kjew5f0ca.result(predicateIds[x].id, $_5pwmxa16ljew5f0cb.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_1e385b16kjew5f0ca.result(id, $_5pwmxa16ljew5f0cb.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_1e385b16kjew5f0ca.result(id, $_5pwmxa16ljew5f0cb.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_e3vy8t16vjew5f0cm.isArray(value)) {
      return value;
    } else if ($_e3vy8t16vjew5f0cm.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_e3vy8t16vjew5f0cm.isBoolean(value)) {
  ...
  var $_biv1hx16ujew5f0ck = {
    getStringOr: getByTypeOr($_e3vy8t16vjew5f0cm.isString),
    getBoolOr: getByTypeOr($_e3vy8t16vjew5f0cm.isBoolean),
    getNumberOr: getByTypeOr($_e3vy8t16vjew5f0cm.isNumber),
    getHandlerOr: getByTypeOr($_e3vy8t16vjew5f0cm.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_e3vy8t16vjew5f0cm.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_908wbj16mjew5f0cc.toClientRect(targetRect),
        contentAreaRect: $_908wbj16mjew5f0cc.toClientRect(contentAreaRect),
        panelRect: $_908wbj16mjew5f0cc.toClientRect(panelRect)
      });
      return $_908wbj16mjew5f0cc.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_biv1hx16ujew5f0ck.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_biv1hx16ujew5f0ck.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_biv1hx16ujew5f0ck.getHandlerOr(editor, 'inline_toolbar_position_handler', $_7zq48u16wjew5f0cn.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_86bas16rjew5f0ch.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_4iheb916sjew5f0ci.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_4iheb916sjew5f0ci.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_390fcv16qjew5f0cg = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_27761316ijew5f0c8.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_46haq116njew5f0cd.fromContextToolbars(toolbars);
    result = $_1e385b16kjew5f0ca.match(editor, [
      $_3uy9g416jjew5f0c9.element(elements[0], contextToolbarsPredicateIds),
      $_4uiw5o16pjew5f0ce.textSelection('text'),
      $_4uiw5o16pjew5f0ce.emptyTextBlock(elements, 'insert'),
      $_3uy9g416jjew5f0c9.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_1e385b16kjew5f0ca.match(editor, [$_4uiw5o16pjew5f0ce.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_390fcv16qjew5f0cg.load(editor, function () {
  ...
  var $_a7n4il16ejew5f0c4 = { renderUI: renderUI };
  ...
  var never$1 = $_b1wu13171jew5f0d2.never;
  var always$1 = $_b1wu13171jew5f0d2.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_b1wu13171jew5f0d2.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_f7x2ev178jew5f0du.parseBox(settings.border);
      self.paddingBox = $_f7x2ev178jew5f0du.parseBox(settings.padding);
      self.marginBox = $_f7x2ev178jew5f0du.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_7gujl817gjew5f0ea.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_f7x2ev178jew5f0du.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_f7x2ev178jew5f0du.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_f7x2ev178jew5f0du.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_3ss68p17fjew5f0e9.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_7gujl817gjew5f0ea.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_7gujl817gjew5f0ea.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_aiviyh17hjew5f0ed = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_7gujl817gjew5f0ea.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_7gujl817gjew5f0ea.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_6zdkx16zjew5f0cv.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_6zdkx16zjew5f0cv.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_f7x2ev178jew5f0du.parseBox(self.settings.border);
          ...
          self.borderBox = $_f7x2ev178jew5f0du.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_a7n4il16ejew5f0c4.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_f6i2h316djew5f0c2 = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_f6sfw4180jew5f0fu.resolve(name, scope);
  };
  ...
  var $_aav8yw17zjew5f0fs = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_aav8yw17zjew5f0fs.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_51itee17xjew5f0fp = { blobToBase64: blobToBase64 };
  ...
  var $_gi814s183jew5f0fw = { pickFile: pickFile };
  ...
  var $_c0yd6v185jew5f0fz = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_6mc3wm187jew5f0gb.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_6mc3wm187jew5f0gb.resolve(dom, bookmark));
  };
  ...
  var $_120461186jew5f0g0 = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_c0yd6v185jew5f0fz.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_120461186jew5f0g0.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_56jdpw184jew5f0fx.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_gi814s183jew5f0fw.pickFile().then(function (files) {
          var blob = files[0];
          $_51itee17xjew5f0fp.blobToBase64(blob).then(function (base64) {
            $_56jdpw184jew5f0fx.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_56jdpw184jew5f0fx.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_5yrh5i17wjew5f0fn = { addToEditor: addToEditor };
  ...
  var $_4gfldu18bjew5f0gh = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_995gip18djew5f0gm.isAbsolute(href) && $_995gip18djew5f0gm.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_56jdpw184jew5f0fx.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_56jdpw184jew5f0fx.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_544th318cjew5f0gj = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_e3vy8t16vjew5f0cm.isArray(items)) {
      return items;
    } else if ($_e3vy8t16vjew5f0cm.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    Tools.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_e3vy8t16vjew5f0cm.isFunction(button)) {
            button = button();
          }
  ...
  var $_4vk32u18ejew5f0gm = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_4vk32u18ejew5f0gm.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_4vk32u18ejew5f0gm.create(editor, 'text', $_4iheb916sjew5f0ci.getTextSelectionToolbarItems(editor)),
        $_4vk32u18ejew5f0gm.create(editor, 'insert', $_4iheb916sjew5f0ci.getInsertToolbarItems(editor)),
        $_544th318cjew5f0gj.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_4iheb916sjew5f0ci.getPositionHandler(editor);
      contentAreaRect = $_5pwmxa16ljew5f0cb.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_7zq48u16wjew5f0cn.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_7zq48u16wjew5f0cn.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_4gfldu18bjew5f0gh.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_7zq48u16wjew5f0cn.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_5pwmxa16ljew5f0cb.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_7zq48u16wjew5f0cn.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_7zq48u16wjew5f0cn.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_86bas16rjew5f0ch.fireBeforeRenderUI(editor);
  ...
  var $_ea0gww191jew5f0i8 = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_b1wu13171jew5f0d2.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_ad991m192jew5f0ia = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_65ev8y196jew5f0il = { cached: cached };

  var $_35x689198jew5f0it = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_35x689198jew5f0it.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_35x689198jew5f0it.ELEMENT);
  var isText = isType$1($_35x689198jew5f0it.TEXT);
  var isDocument = isType$1($_35x689198jew5f0it.DOCUMENT);
  var $_8lw7w6197jew5f0im = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_8lw7w6197jew5f0im.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_65ev8y196jew5f0il.cached(function () {
    return getBody($_ad991m192jew5f0ia.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_ad991m192jew5f0ia.fromDom(body);
  };
  var $_2hjndn195jew5f0ii = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_6zdkx16zjew5f0cv.each(fields, function (name, i) {
        struct[name] = $_b1wu13171jew5f0d2.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_a0xc5e19ajew5f0j9.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_6zdkx16zjew5f0cv.each(array, function (a) {
      if (!$_a0xc5e19ajew5f0j9.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_6zdkx16zjew5f0cv.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_63w0w219fjew5f0jo.validateStrArr('required', required);
    $_63w0w219fjew5f0jo.validateStrArr('optional', optional);
    $_63w0w219fjew5f0jo.checkDupes(everything);
    return function (obj) {
      var keys = $_3p6vus19ejew5f0jm.keys(obj);
      var allReqd = $_6zdkx16zjew5f0cv.forall(required, function (req) {
        return $_6zdkx16zjew5f0cv.contains(keys, req);
      });
      if (!allReqd)
        $_63w0w219fjew5f0jo.reqMessage(required, keys);
      var unsupported = $_6zdkx16zjew5f0cv.filter(keys, function (key) {
        return !$_6zdkx16zjew5f0cv.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_63w0w219fjew5f0jo.unsuppMessage(unsupported);
      var r = {};
      $_6zdkx16zjew5f0cv.each(required, function (req) {
        r[req] = $_b1wu13171jew5f0d2.constant(obj[req]);
      });
      $_6zdkx16zjew5f0cv.each(optional, function (opt) {
        r[opt] = $_b1wu13171jew5f0d2.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_9y9t6019bjew5f0ja = {
    immutable: Immutable,
  ...
  var $_eslhll19gjew5f0jq = { toArray: toArray };

  var node = function () {
    var f = $_aav8yw17zjew5f0fs.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_18nm5c19mjew5f0k6.unknown()
    });
  };
  ...
  var $_7boiy419ljew5f0k3 = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_b1wu13171jew5f0d2.constant(edge),
    chrome: $_b1wu13171jew5f0d2.constant(chrome),
    ie: $_b1wu13171jew5f0d2.constant(ie),
    opera: $_b1wu13171jew5f0d2.constant(opera),
    firefox: $_b1wu13171jew5f0d2.constant(firefox),
    safari: $_b1wu13171jew5f0d2.constant(safari)
  };
  ...
  var $_8i2iaf19njew5f0k8 = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_b1wu13171jew5f0d2.constant(windows$1),
    ios: $_b1wu13171jew5f0d2.constant(ios),
    android: $_b1wu13171jew5f0d2.constant(android),
    linux: $_b1wu13171jew5f0d2.constant(linux),
    osx: $_b1wu13171jew5f0d2.constant(osx),
    solaris: $_b1wu13171jew5f0d2.constant(solaris),
    freebsd: $_b1wu13171jew5f0d2.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_b1wu13171jew5f0d2.constant(isiPad),
      isiPhone: $_b1wu13171jew5f0d2.constant(isiPhone),
      isTablet: $_b1wu13171jew5f0d2.constant(isTablet),
      isPhone: $_b1wu13171jew5f0d2.constant(isPhone),
      isTouch: $_b1wu13171jew5f0d2.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_b1wu13171jew5f0d2.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_6zdkx16zjew5f0cv.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_18nm5c19mjew5f0k6.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_18nm5c19mjew5f0k6.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_fdfgxi19sjew5f0kn.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_fdfgxi19sjew5f0kn.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_fdfgxi19sjew5f0kn.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_fdfgxi19sjew5f0kn.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_9uuinq19tjew5f0ko.head(str).bind(function (head) {
      return $_9uuinq19tjew5f0ko.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_fhlo6719rjew5f0kl.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_fhlo6719rjew5f0kl.contains(uastring, 'edge/') && $_fhlo6719rjew5f0kl.contains(uastring, 'chrome') && $_fhlo6719rjew5f0kl.contains(uastring, 'safari') && $_fhlo6719rjew5f0kl.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_fhlo6719rjew5f0kl.contains(uastring, 'chrome') && !$_fhlo6719rjew5f0kl.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_fhlo6719rjew5f0kl.contains(uastring, 'msie') || $_fhlo6719rjew5f0kl.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_fhlo6719rjew5f0kl.contains(uastring, 'safari') || $_fhlo6719rjew5f0kl.contains(uastring, 'mobile/')) && $_fhlo6719rjew5f0kl.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_fhlo6719rjew5f0kl.contains(uastring, 'iphone') || $_fhlo6719rjew5f0kl.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_2tffrt19qjew5f0kg = {
    browsers: $_b1wu13171jew5f0d2.constant(browsers),
    oses: $_b1wu13171jew5f0d2.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_2tffrt19qjew5f0kg.browsers();
    var oses = $_2tffrt19qjew5f0kg.oses();
    var browser = $_av4arp19pjew5f0kd.detectBrowser(browsers, userAgent).fold($_7boiy419ljew5f0k3.unknown, $_7boiy419ljew5f0k3.nu);
    var os = $_av4arp19pjew5f0kd.detectOs(oses, userAgent).fold($_8i2iaf19njew5f0k8.unknown, $_8i2iaf19njew5f0k8.nu);
  ...
  var $_6x7dmz19kjew5f0k2 = { detect: detect$2 };

  var detect$3 = $_65ev8y196jew5f0il.cached(function () {
    var userAgent = navigator.userAgent;
    return $_6x7dmz19kjew5f0k2.detect(userAgent);
  });
  var $_9ms3xa19jjew5f0k0 = { detect: detect$3 };

  var ELEMENT = $_35x689198jew5f0it.ELEMENT;
  var DOCUMENT = $_35x689198jew5f0it.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_6zdkx16zjew5f0cv.map(base.querySelectorAll(selector), $_ad991m192jew5f0ia.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_ad991m192jew5f0ia.fromDom);
  };
  var $_c0wuuu19ujew5f0kp = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_6zdkx16zjew5f0cv.exists(elements, $_b1wu13171jew5f0d2.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_1ehxdb19ijew5f0jz.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_9ms3xa19jjew5f0k0.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_en24mg19hjew5f0js = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_c0wuuu19ujew5f0kp.is
  };

  var owner = function (element) {
    return $_ad991m192jew5f0ia.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_ad991m192jew5f0ia.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_ad991m192jew5f0ia.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_ad991m192jew5f0ia.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_6zdkx16zjew5f0cv.findIndex(kin, function (elem) {
        return $_en24mg19hjew5f0js.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_a0xc5e19ajew5f0j9.isFunction(isRoot) ? isRoot : $_b1wu13171jew5f0d2.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_ad991m192jew5f0ia.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_6zdkx16zjew5f0cv.filter(elements, function (x) {
        return !$_en24mg19hjew5f0js.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_ad991m192jew5f0ia.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_ad991m192jew5f0ia.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_ad991m192jew5f0ia.fromDom);
  };
  var prevSiblings = function (element) {
    return $_6zdkx16zjew5f0cv.reverse($_eslhll19gjew5f0jq.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_eslhll19gjew5f0jq.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_6zdkx16zjew5f0cv.map(dom.childNodes, $_ad991m192jew5f0ia.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_ad991m192jew5f0ia.fromDom);
  };
  ...
  var spot = $_9y9t6019bjew5f0ja.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_dasuvm199jew5f0iv = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_2hjndn195jew5f0ii.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_6zdkx16zjew5f0cv.filter($_dasuvm199jew5f0iv.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_6zdkx16zjew5f0cv.filter($_dasuvm199jew5f0iv.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_6zdkx16zjew5f0cv.filter($_dasuvm199jew5f0iv.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_6zdkx16zjew5f0cv.each($_dasuvm199jew5f0iv.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_c0wuuu19ujew5f0kp.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_3ei7t7194jew5f0if.ancestors(scope, function (e) {
      return $_c0wuuu19ujew5f0kp.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_3ei7t7194jew5f0if.siblings(scope, function (e) {
      return $_c0wuuu19ujew5f0kp.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_3ei7t7194jew5f0if.children(scope, function (e) {
      return $_c0wuuu19ujew5f0kp.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_c0wuuu19ujew5f0kp.all(selector, scope);
  };
  var $_2zceqj193jew5f0ie = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_6zdkx16zjew5f0cv.map($_2zceqj193jew5f0ie.descendants($_ad991m192jew5f0ia.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_ea0gww191jew5f0i8.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_b1wu13171jew5f0d2.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_6zdkx16zjew5f0cv.map($_6zdkx16zjew5f0cv.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_6zdkx16zjew5f0cv.map($_6zdkx16zjew5f0cv.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_6zdkx16zjew5f0cv.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_7awco4190jew5f0i1 = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_b1wu13171jew5f0d2.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_6zdkx16zjew5f0cv.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_6zdkx16zjew5f0cv.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_6zdkx16zjew5f0cv.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_6zdkx16zjew5f0cv.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_6zdkx16zjew5f0cv.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_7awco4190jew5f0i1.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_a0xc5e19ajew5f0j9.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_2hjndn195jew5f0ii.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_ad991m192jew5f0ia.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_ad991m192jew5f0ia.fromDom(element.parentNode), function (x) {
      return !$_en24mg19hjew5f0js.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_6zdkx16zjew5f0cv.find(scope.dom().childNodes, $_b1wu13171jew5f0d2.compose(predicate, $_ad991m192jew5f0ia.fromDom));
    return result.map($_ad991m192jew5f0ia.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_ad991m192jew5f0ia.fromDom(element.childNodes[i])))
          return Option.some($_ad991m192jew5f0ia.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_c0wuuu19ujew5f0kp.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_1rbc7f1a0jew5f0l5.ancestor(scope, function (e) {
      return $_c0wuuu19ujew5f0kp.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_1rbc7f1a0jew5f0l5.sibling(scope, function (e) {
      return $_c0wuuu19ujew5f0kp.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_1rbc7f1a0jew5f0l5.child(scope, function (e) {
      return $_c0wuuu19ujew5f0kp.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_c0wuuu19ujew5f0kp.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_c0wuuu19ujew5f0kp.is, ancestor$1, scope, selector, isRoot);
  };
  var $_ema43p19zjew5f0l4 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_1imku91a3jew5f0ls.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_1imku91a3jew5f0ls.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_1imku91a3jew5f0ls.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_1imku91a3jew5f0ls.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_1imku91a3jew5f0ls.postRenderFormat(editor, name)
      });
    });
  };
  var $_96uu3e1a2jew5f0lr = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_ad991m192jew5f0ia.fromDom).filter($_8lw7w6197jew5f0im.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_fga9j51a5jew5f0lv = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_b1wu13171jew5f0d2.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_fga9j51a5jew5f0lv.getFontFamily(editor.getBody(), e.element);
  ...
  var $_cgghkk1a4jew5f0lt = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_fga9j51a5jew5f0lv.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_fga9j51a5jew5f0lv.toPt(px, precision);
  ...
  var $_f05xvn1a6jew5f0m0 = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_1imku91a3jew5f0ls.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_fhjkfj1a7jew5f0m3 = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_1imku91a3jew5f0ls.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_1imku91a3jew5f0ls.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_6aqho41a8jew5f0m6 = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_6zdkx16zjew5f0cv.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_6zdkx16zjew5f0cv.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_6zdkx16zjew5f0cv.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_b36uwv1a9jew5f0m8 = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_1imku91a3jew5f0ls.postRenderFormat(editor, name),
        onclick: $_1imku91a3jew5f0ls.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_1imku91a3jew5f0ls.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_9qjarh1aajew5f0mc = { register: register$6 };
  ...
  var $_c49q9u1abjew5f0me = { register: register$7 };
  ...
  var $_5k7lek1acjew5f0mf = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_ema43p19zjew5f0l4.descendant($_ad991m192jew5f0ia.fromDom(document.body), editor.settings.ui_container).fold($_b1wu13171jew5f0d2.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_6aqho41a8jew5f0m6.register(editor);
    $_96uu3e1a2jew5f0lr.register(editor);
    $_9qjarh1aajew5f0mc.register(editor);
    $_c49q9u1abjew5f0me.register(editor);
    $_f05xvn1a6jew5f0m0.register(editor);
    $_cgghkk1a4jew5f0lt.register(editor);
    $_fhjkfj1a7jew5f0m3.register(editor);
    $_5k7lek1acjew5f0mf.register(editor);
    $_b36uwv1a9jew5f0m8.register(editor);
  };
  var $_1gqn7n19yjew5f0l0 = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_a0xc5e19ajew5f0j9.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_a0xc5e19ajew5f0j9.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_3ss68p17fjew5f0e9,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_fw4hq017tjew5f0fi,
      Panel: Panel,
      Movable: $_aiviyh17hjew5f0ed,
      Resizable: $_2bdncz17ujew5f0fk,
      ...
      FormatControls: $_1gqn7n19yjew5f0l0,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = create$3();
    $_1gqn7n19yjew5f0l0.setup(editor);
    $_5yrh5i17wjew5f0fn.addToEditor(editor, panel);
    return $_f6i2h316djew5f0c2.get(editor, panel);
  });
  function Theme () {
  }
