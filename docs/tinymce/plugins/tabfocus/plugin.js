...
var tabfocus = (function () {
  ...
  var $_ewy1y0jmjew5etel = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_ewy1y0jmjew5etel.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_5w1tnfjfjew5eteh = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_5w1tnfjfjew5eteh.setup(editor);
  });
  function Plugin () {
  }
