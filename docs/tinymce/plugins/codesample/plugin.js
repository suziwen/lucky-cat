...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_dv5ch49njew5es82.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_c2c8919jjew5es7a.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_97yhvb9ljew5es7c.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_7jthtb9ojew5es83 = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_5ya2mm9ijew5es79 = {
    open: function (editor) {
      var minWidth = $_c2c8919jjew5es7a.getDialogMinWidth(editor);
      var minHeight = $_c2c8919jjew5es7a.getDialogMinHeight(editor);
      var currentLanguage = $_7jthtb9ojew5es83.getCurrentLanguage(editor);
      var currentLanguages = $_7jthtb9ojew5es83.getLanguages(editor);
      var currentCode = $_97yhvb9ljew5es7c.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_97yhvb9ljew5es7c.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_dv5ch49njew5es82.isCodeSample(node)) {
        $_5ya2mm9ijew5es79.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_ewjwme9hjew5es77 = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_dv5ch49njew5es82.trimArg($_dv5ch49njew5es82.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_dv5ch49njew5es82.trimArg($_dv5ch49njew5es82.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_e5kmuu9pjew5es84 = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_c2c8919jjew5es7a.getContentCss(editor);
  ...
  var $_giyvwd9qjew5es86 = { loadCss: loadCss };
  ...
  var $_1nmgln9rjew5es87 = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_e5kmuu9pjew5es84.setup(editor);
    $_1nmgln9rjew5es87.register(editor);
    $_ewjwme9hjew5es77.register(editor);
    editor.on('init', function () {
      $_giyvwd9qjew5es86.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_dv5ch49njew5es82.isCodeSample(ev.target)) {
        $_5ya2mm9ijew5es79.open(editor);
      }
    });
  });
