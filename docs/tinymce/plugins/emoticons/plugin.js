...
var emoticons = (function () {
  ...
  var $_2suyqcahjew5esap = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_2suyqcahjew5esap.getHtml(pluginUrl);
  ...
  var $_5oamddagjew5esan = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_5oamddagjew5esan.register(editor, pluginUrl);
  });
  function Plugin () {
  }
