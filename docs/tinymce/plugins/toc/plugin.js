...
var toc = (function () {
  ...
  var $_da1ujiqyjew5evyq = { create: create };

  var tocId = $_da1ujiqyjew5evyq.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_e3pf12qxjew5evyp.getTocClass(editor);
    var headerTag = $_e3pf12qxjew5evyp.getTocHeader(editor);
    var selector = generateSelector($_e3pf12qxjew5evyp.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_e3pf12qxjew5evyp.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_e3pf12qxjew5evyp.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_d8kugmqtjew5evyl.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_d8kugmqtjew5evyl.updateToc(editor);
    });
  };
  var $_7b0kgnqsjew5evyj = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_e3pf12qxjew5evyp.getTocClass(editor);
  ...
  var $_8bfy2qzjew5evyr = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_d8kugmqtjew5evyl.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_e3pf12qxjew5evyp.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_g6ahter0jew5evys = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_7b0kgnqsjew5evyj.register(editor);
    $_g6ahter0jew5evys.register(editor);
    $_8bfy2qzjew5evyr.setup(editor);
  });
  function Plugin () {
  }
