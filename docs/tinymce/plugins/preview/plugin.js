...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_7wy1a0i6jew5etao.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_7wy1a0i6jew5etao.getPreviewDialogWidth(editor);
    var dialogHeight = $_7wy1a0i6jew5etao.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_1dvhbki7jew5etap.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_2we3fsi4jew5etam = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_2we3fsi4jew5etam.open(editor);
    });
  };
  var $_681ecvi3jew5etal = { register: register };
  ...
  var $_bxbfnii9jew5etar = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_681ecvi3jew5etal.register(editor);
    $_bxbfnii9jew5etar.register(editor);
  });
  function Plugin () {
  }
