...
var contextmenu = (function () {
  ...
  var $_ad5wjha2jew5es9u = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_cfzpva1jew5es9m.getContextMenu(editor);
  ...
  var $_dxlenya5jew5es9y = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_cfzpva1jew5es9m.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_dxlenya5jew5es9y.show(editor, $_ad5wjha2jew5es9u.getPos(editor, e), visibleState, menu);
    });
  };
  var $_8k5hqya0jew5es9l = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_8k5hqya0jew5es9l.setup(editor, visibleState, menu);
    return $_7bxzox9zjew5es9j.get(visibleState);
  });
  function Plugin () {
  }
