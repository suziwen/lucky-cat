...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_ddshjse5jew5esxy.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_ddshjse5jew5esxy.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_ddshjse5jew5esxy.getSelectorConverter(editor)) {
      selectorConverter = $_ddshjse5jew5esxy.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_ddshjse5jew5esxy.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_ddshjse5jew5esxy.getCssGroups(editor));
      ...
      if (!$_ddshjse5jew5esxy.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_ddshjse5jew5esxy.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_dlrekse0jew5esxs.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_8zbwk7dzjew5esxq = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_dlrekse0jew5esxs.setup(editor);
    return $_8zbwk7dzjew5esxq.get(editor);
  });
  function Plugin () {
  }
