...
var spellchecker = (function () {
  ...
  var $_6gfr1xizjew5etd3 = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      XHR.send({
        url: new URI(pluginUrl).toAbsolute($_esggwyj1jew5etd5.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_esggwyj1jew5etd5.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_esggwyj1jew5etd5.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_g7s90rj6jew5etdc.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_esggwyj1jew5etd5.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_g7s90rj6jew5etdc.fireSpellcheckStart(editor);
  };
  var $_30j3j0j2jew5etd7 = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, url) {
    var getLanguage = function () {
      return $_esggwyj1jew5etd5.getLanguage(editor);
    };
    var getWordCharPattern = function () {
      return $_esggwyj1jew5etd5.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_30j3j0j2jew5etd7.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_6ecm6oj0jew5etd4 = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_30j3j0j2jew5etd7.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_4hgnxfj8jew5etdj = { register: register };
  ...
  var updateSelection = function (editor) {
    return function (e) {
      var selectedLanguage = $_esggwyj1jew5etd5.getLanguage(editor);
  ...
  var getItems = function (editor) {
    return Tools.map($_esggwyj1jew5etd5.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_crug1vj9jew5etdk = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState, word, spans) {
    ...
    Tools.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_30j3j0j2jew5etd7.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_30j3j0j2jew5etd7.addToDictionary(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_30j3j0j2jew5etd7.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_30j3j0j2jew5etd7.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_30j3j0j2jew5etd7.findSpansByIndex(editor, $_30j3j0j2jew5etd7.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_f3to59jajew5etdm = { setup: setup };

  PluginManager.add('spellchecker', function (editor, pluginUrl) {
    if ($_6gfr1xizjew5etd3.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_esggwyj1jew5etd5.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell({});
      $_crug1vj9jew5etdk.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_f3to59jajew5etdm.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState);
      $_4hgnxfj8jew5etdj.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_6ecm6oj0jew5etd4.get(editor, startedState, lastSuggestionsState, textMatcherState, pluginUrl);
    }
  });
  function Plugin () {
  }
