...
var help = (function () {
  ...
  var never$1 = $_9cdrcvaqjew5esbf.never;
  var always$1 = $_9cdrcvaqjew5esbf.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_9cdrcvaqjew5esbf.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_b7vp1masjew5esbi = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_186xijaojew5esb5.map($_b7vp1masjew5esbi.shortcuts, function (shortcut) {
  ...
  var $_cy5neanjew5esaz = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_d43rlqaxjew5esby.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_d43rlqaxjew5esby.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_d43rlqaxjew5esby.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_d43rlqaxjew5esby.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_c589olayjew5esbz.head(str).bind(function (head) {
      return $_c589olayjew5esbz.tail(str).map(function (tail) {
  ...
  var $_5o9d4eazjew5esc5 = { urls: urls };

  var makeLink = $_9cdrcvaqjew5esbf.curry($_6ini7iawjew5esbw.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_186xijaojew5esb5.find($_5o9d4eazjew5esc5.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_311k2mavjew5esbt.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_186xijaojew5esb5.filter(keys, $_9cdrcvaqjew5esbf.not($_9cdrcvaqjew5esbf.curry($_186xijaojew5esb5.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_186xijaojew5esb5.map(pluginKeys, function (key) {
  ...
  var $_919zspaujew5esbl = { makeTab: makeTab$1 };
  ...
  var $_b8s14lb0jew5esc7 = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_cy5neanjew5esaz.makeTab(),
          $_919zspaujew5esbl.makeTab(editor)
        ],
        buttons: $_b8s14lb0jew5esc7.makeRow(),
  ...
  var $_4zqxivamjew5esay = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_4zqxivamjew5esay.open(editor, pluginUrl));
  };
  var $_37ktehaljew5esax = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_4zqxivamjew5esay.open(editor, pluginUrl)
    });
  ...
  var $_u2abyb2jew5esc9 = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_u2abyb2jew5esc9.register(editor, pluginUrl);
    $_37ktehaljew5esax.register(editor, pluginUrl);
