...
var wordcount = (function () {
  ...
  var $_3ncldps4jew5ew2g = {
    each: each,
    map: map
  };

  var SETS$1 = $_bs4wdus2jew5ew2c.SETS;
  var OTHER = $_bs4wdus2jew5ew2c.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_3ncldps4jew5ew2g.map(string.split(''), memoized);
  };
  var $_ibllms3jew5ew2f = { classify: classify };

  var ci = $_bs4wdus2jew5ew2c.characterIndices;
  ...
  var $_28vxqls5jew5ew2j = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_bs4wdus2jew5ew2c.EMPTY_STRING;
  var WHITESPACE$1 = $_bs4wdus2jew5ew2c.WHITESPACE;
  var PUNCTUATION$1 = $_bs4wdus2jew5ew2c.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_ibllms3jew5ew2f.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_28vxqls5jew5ew2j.isWordBoundary(map, i)) {
  ...
  var $_auy66vs1jew5ew24 = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_auy66vs1jew5ew24.getWords(getTextContent(editor)).length;
  };
  var $_fcyoths0jew5ew22 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_fcyoths0jew5ew22.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_e6lihurzjew5ew22 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_fcyoths0jew5ew22.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_44mk5zs6jew5ew2m = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_44mk5zs6jew5ew2m.setup(editor);
    return $_e6lihurzjew5ew22.get(editor);
  });
  function Plugin () {
  }
