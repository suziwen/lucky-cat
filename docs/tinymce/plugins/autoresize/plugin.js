...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_9hbwym8cjew5es46.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_9hbwym8cjew5es46.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_9hbwym8cjew5es46.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_9hbwym8cjew5es46.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_9hbwym8cjew5es46.getAutoResizeBottomMargin(editor);
    ...
    if ($_9hbwym8cjew5es46.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_an72la89jew5es43.resize(editor, oldSize);
    });
  };
  var $_a78igi88jew5es41 = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_a78igi88jew5es41.register(editor, oldSize);
      $_an72la89jew5es43.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
