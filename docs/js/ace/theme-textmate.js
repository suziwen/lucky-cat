...
exports.cssText = ".ace-textmate .ace_gutter {\
background: #f0f0f0;\
color: #333;\
}\
.ace-textmate .ace_print-margin {\
width: 1px;\
background: #e8e8e8;\
}\
...
.ace-textmate .ace_constant.ace_buildin {\
color: rgb(88, 72, 246);\
}\
.ace-textmate .ace_constant.ace_language {\
color: rgb(88, 92, 246);\
}\
.ace-textmate .ace_constant.ace_library {\
color: rgb(6, 150, 14);\
}\
...
.ace-textmate .ace_keyword.ace_operator {\
...
.ace-textmate .ace_comment.ace_doc {\
color: rgb(0, 102, 255);\
}\
.ace-textmate .ace_comment.ace_doc.ace_tag {\
...
.ace-textmate .ace_xml-pe {\
color: rgb(104, 104, 91);\
}\
.ace-textmate .ace_entity.ace_name.ace_function {\
color: #0000A2;\
}\
.ace-textmate .ace_heading {\
color: rgb(12, 7, 255);\
}\
.ace-textmate .ace_list {\
color:rgb(185, 6, 144);\
}\
.ace-textmate .ace_meta.ace_tag {\
color:rgb(0, 22, 142);\
}\
.ace-textmate .ace_string.ace_regex {\
color: rgb(255, 0, 0)\
}\
.ace-textmate .ace_marker-layer .ace_selection {\
background: rgb(181, 213, 255);\
}\
.ace-textmate.ace_multiselect .ace_selection.ace_start {\
box-shadow: 0 0 3px 0px white;\
}\
.ace-textmate .ace_marker-layer .ace_step {\
background: rgb(252, 255, 0);\
}\
.ace-textmate .ace_marker-layer .ace_stack {\
...
.ace-textmate .ace_marker-layer .ace_active-line {\
background: rgba(0, 0, 0, 0.07);\
}\
.ace-textmate .ace_gutter-active-line {\
background-color : #dcdcdc;\
}\
.ace-textmate .ace_marker-layer .ace_selected-word {\
background: rgb(250, 250, 255);\
border: 1px solid rgb(200, 200, 250);\
}\
.ace-textmate .ace_indent-guide {\
